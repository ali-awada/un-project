        ...
        <div class="col-7 mb-4">
            <div class="card" style="height:100%;">
                ...
                <h5 class="card-title">{{$product->ar_name}}</h5> -->
                    ...
                    <p class="card-text"><a href="{{route('userCategory.show',$product->category->id)}}"
                                            class="text-muted">{{$product->category->en_name}}</a></p>
                    <p class="text-success"><a href="{{route('userBrand.show', $product->brand->id)}}"
                                               class="text-muted">{{$product->brand->name}}</a></p>
                                ...
                                <form action="{{route('order.create')}}" method="post">
                                    ...
                                    <div class="modal-body">
                                        <div class="form-group">
                                            @csrf
                                            <input name="currency_id" hidden type="text"
